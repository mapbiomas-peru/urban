var param = {
    code_region: 70304,
    pais: 'PERU',
    // year_view: [1985,2021,2022],  // Solo visualizacion  
    version_input: '1', //COLECCION 5             1
    version_output: '51', // COLECCION 5           11
...
var list_nuaci_th = ee.List.sequence(150, 135, -0.1,38).getInfo();
...
years.forEach(function(year) {
    ...
    print(year, list_nuaci_th[year - 1985]);
