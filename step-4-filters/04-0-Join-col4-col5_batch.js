...
for (var ireg = 0; ireg<listregion.length; ireg ++) {
  ...
  var param = {
      ...
      version_input: listregion[ireg][1], //COLECCION 5             1
      version_output: '11', // COLECCION 5           11
  ...
  // var colleccion5 = collection4.addBands(Clasificacion, null, true).updateMask(regionRaster)
