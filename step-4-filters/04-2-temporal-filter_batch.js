...
var param = { 
    ...
    version_input: listregion[ireg][1], // revisar version de input de clasificacion 
    version_output: '23',
...
Map.addLayer(Clasificacion_TD, vis, 'original'+param.year, false);

Map.addLayer(filtered, vis, 'filtered'+param.year, false);
