...
var inclusion = /* color: #3614d6 */ee.FeatureCollection(
    ...
    exclusion = /* color: #fc11ff */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Polygon(
    ...
    geometry_27 = /* color: #191919 */ee.FeatureCollection(
        [ee.Feature(
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-78.13627374433537, -6.8705504137557805],
                  [-78.13584459089299, -6.870166949094183],
                  [-78.13738954328556, -6.868462657968401],
                  [-78.13738954328556, -6.8699539130374525]]]),
            {
              "id": 27,
              "system:index": "3"
            })]),
    geometry_24 = /* color: #ff0000 */ee.FeatureCollection(
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-78.14412725233097, -6.879412621964906],
                  [-78.14447057508488, -6.8780066095792405],
                  [-78.14545762800236, -6.8795404410663]]]),
            {
              "id": 24,
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-78.14074648287134, -6.868500495154328],
                  [-78.14503801729516, -6.86296150727081],
                  [-78.14692629244165, -6.868117028839924]]]),
            {
              "id": 24,
              "system:index": "3"
            })]),
    Muestra24_1985_1990 = /* color: #ffd124 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([-75.22901620680454, -12.071139139583007]),
            {
              "reference": 24,
              "t0": 2021,
              "t1": 2021,
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-75.22919859701756, -12.071202089220966],
                  [-75.2290108423865, -12.071198154869023],
                  [-75.22880297118785, -12.071080124283988]]]),
            {
              "reference": 24,
              "t0": 2021,
              "t1": 2021,
        ...
        ee.Feature(
            ee.Geometry.Polygon(
                [[[-78.14276593234239, -6.872176794608684],
                  [-78.14057724978623, -6.872475043667026],
                  [-78.14006226565537, -6.869620366434152],
                  [-78.143238001129, -6.8704725106861195]]]),
            {
              "reference": 24,
              "t0": 2021,
              "t1": 2021,
