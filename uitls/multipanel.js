...
var regionclas = ee.FeatureCollection(regionesclass).filterMetadata('id_regionC', 'equals', param.code_region);
// print(regionclas)
...
// Create a title.
var title = ui.Label('Urban Clasification of Collection 1 - Mapbiomas Colombia - '+param.code_region, {
    stretch: 'horizontal',
    textAlign: 'center',
    fontWeight: 'bold',
    fontSize: '24px',
